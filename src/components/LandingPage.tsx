...
import OrbitingReviewsCarousel from './ui/orbiting-reviews-carousel';
...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white overflow-hidden relative" onMouseMove={handleMouseMove}>
      ...
      {/* Success Stories Section with Orbiting Carousel */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 animate-on-scroll">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Real Success <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-cyan-500">Stories</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-4xl mx-auto">
              Join thousands of traders who have successfully cleared prop firm challenges and achieved funded status
            </p>
          </div>

          <div className="mt-12">
            <OrbitingReviewsCarousel />
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6">
                <div className="flex items-center justify-center mb-2">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} size={16} className="fill-yellow-400 text-yellow-400 mx-0.5" />
                  ))}
                </div>
                <p className="text-2xl font-bold text-white mb-1">4.9/5</p>
                <p className="text-sm text-gray-400">Average Rating</p>
              </div>
              <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6">
                <TrendingUp className="w-8 h-8 text-green-400 mx-auto mb-2" />
                <p className="text-2xl font-bold text-white mb-1">2,847+</p>
                <p className="text-sm text-gray-400">Funded Traders</p>
              </div>
              <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6">
                <Award className="w-8 h-8 text-blue-400 mx-auto mb-2" />
                <p className="text-2xl font-bold text-white mb-1">86.7%</p>
